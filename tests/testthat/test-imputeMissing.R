...
test_that("imputeMissing correctly imputes and handles edge cases", {
  ...
  # Run the imputation
  out_impute <- ReproducibleYostIndex:::imputeMissing(df_geo, quiet = TRUE)
...
test_that("imputeMissing performs weighted imputation correctly", {
  ...
  out_weighted <- ReproducibleYostIndex:::imputeMissing(df_geo, weight_var_sub = "tot_pop", quiet = TRUE)
...
test_that("imputeMissing handles empty geometries gracefully", {
  ...
  out_impute <- suppressMessages(ReproducibleYostIndex:::imputeMissing(df_geo, quiet = TRUE))
...
test_that("imputeMissing errors on missing required columns", {
  ...
  expect_error(
    ReproducibleYostIndex:::imputeMissing(df_bad, quiet = TRUE),
...
test_that("imputeMissing handles weight_var = 'none'", {
  ...
  out_unweighted <- ReproducibleYostIndex:::imputeMissing(df_geo, weight_var_sub = "none", quiet = TRUE)
