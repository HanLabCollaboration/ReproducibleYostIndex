...
test_that("getYost returns correct structure for county/national", {
  ...
  expect_named(df, c(
    ...
    "Yost", "YostQuintile",
    "YostShrunk", "YostShrunkQuintile",
    "YostImputed", "YostImputedQuintile",
    "YostShrunkImputed", "YostShrunkImputedQuintile"
  ))
...
test_that("getYost returns all quintile values in 1:5 range", {
  ...
  expect_true(check_quintile(df$YostShrunkQuintile))
  expect_true(check_quintile(df$YostImputedQuintile))
  expect_true(check_quintile(df$YostShrunkImputedQuintile))
})
